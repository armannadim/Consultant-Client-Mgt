...
Route::get('appconfig', array('as' => 'appconfig', 'uses' => 'HomeController@viewAppManagement'));
...
Route::post('addConfig', array('as' => 'addConfig', 'uses' => 'AppController@CreateConfigAction'));
Route::post('removeConfig/{id}', array('as' => 'removeConfig', 'uses' => 'AppController@DeleteConfigAction'));
Route::post('modifyConfig/{id}', array('as' => 'modifyConfig', 'uses' => 'AppController@UpdateConfigAction'));
